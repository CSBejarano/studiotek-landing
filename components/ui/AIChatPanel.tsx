              ...
              <div className="flex items-center justify-between px-5 py-4 border-b border-white/[0.06] flex-shrink-0">
                <div className="flex items-center gap-3">
                  ...
                  <div className="relative w-9 h-9 rounded-xl overflow-hidden">
                    ...
                    />
                    <span className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-green-400 rounded-full border-2 border-[#0C0C0F]" />
                  </div>
                  <div>
                    <span className="text-white font-semibold text-sm">StudioTek IA</span>
                    <p className="text-[11px] text-green-400 font-medium">En linea</p>
                  </div>
                </div>
                <button
                  onClick={closePanel}
              ...
              <div className="flex-1 overflow-y-auto px-5 py-5 space-y-4">
                {messages.length === 0 && (
                  <div className="flex flex-col items-center justify-center h-full text-center px-4">
                    {/* Logo grande */}
                    <div className="w-16 h-16 rounded-2xl overflow-hidden mb-5 shadow-lg">
                      <Image
                        src="/logo-icon.png"
                        alt="StudioTek AI"
                        width={64}
                    ...
                    <h3 className="text-white/90 font-semibold text-base mb-1.5">
                      Hola, soy el asistente de StudioTek
                    </h3>
                    <p className="text-white/40 text-sm max-w-[260px] leading-relaxed mb-8">
                      Pregunta lo que quieras sobre automatizacion con IA para tu negocio
                    </p>
                    {/* Quick replies */}
