    ...
    >
      <div className="max-w-7xl mx-auto px-4 md:px-3 lg:px-4 h-16 flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 lg:gap-4">
          ...
          {/* Mobile hamburger */}
          <button
            className="md:hidden flex items-center justify-center w-10 h-10 text-[#9CA3AF] hover:text-white transition-colors"
          ...
          <div className="max-w-7xl mx-auto px-4 py-4 flex flex-col gap-3">
            {NAV_LINKS.map((link) => (
              <a
                ...
                href={link.href}
                onClick={(e) => handleNavClick(e, link.href)}
                className="text-base font-medium text-[#9CA3AF] hover:text-white transition-colors duration-200 py-2"
              >
                {link.label}
              </a>
            ))}
